...
control ncl_compute(inout headers H,
	...
	table ncvm_swi_tbl_0 {
		...
		const size = 4;
		const entries = {
			6 : ncvm_swi_tbl_0_action_0;
			4 : ncvm_swi_tbl_0_action_1;
			0 : ncvm_swi_tbl_0_action_2;
			2 : ncvm_swi_tbl_0_action_3;
		}
	}
	...
	RegisterAction<bit<32>, bit<16>, bit<32>>(_mem_HitCounts0) __ra__ncvm_atomic_cond_write_u32_11_0_0_le_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			if (((bool) _lv__2_bitmap[0:0])) {
				R = 0;
	...
	RegisterAction<bit<32>, bit<16>, bit<32>>(_mem_HitCounts1) __ra__ncvm_atomic_cond_write_u32_12_0_0_le_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			if (!((bool) _lv__2_bitmap[0:0])) {
				R = 0;
	...
	RegisterAction<bit<32>, bit<16>, bit<32>>(_mem_HitCounts0) __ra__ncvm_atomic_cond_sadd_u32_15_1_0_le_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = R;
			if (((bool) _lv__2_bitmap[0:0])) {
				R = (R |+| 1);
	...
	RegisterAction<bit<32>, bit<16>, bit<32>>(_mem_HitCounts1) __ra__ncvm_atomic_cond_sadd_u32_16_1_0_le_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = R;
			if (!((bool) _lv__2_bitmap[0:0])) {
				R = (R |+| 1);
	...
	RegisterAction<bit<8>, bit<16>, bool>(_mem_Valid0) __ra__ncvm_atomic_cond_write_bool_17_1_1_le_0_ = {
		void apply(inout bit<8> R, out bool O){
			O = ((bool) ((bit<1>) R));
			if (((bool) _lv__2_bitmap[0:0])) {
				R = ((bit<8>) 0);
	...
	RegisterAction<bit<8>, bit<16>, bool>(_mem_Valid1) __ra__ncvm_atomic_cond_write_bool_18_1_1_le_0_ = {
		void apply(inout bit<8> R, out bool O){
			O = ((bool) ((bit<1>) R));
			if (!((bool) _lv__2_bitmap[0:0])) {
				R = ((bit<8>) 0);
	...
	action mem_rmw_10_mem_Valid0(in bit<16> i) {	__ra__ncvm_atomic_cond_write_bool_17_1_1_le_0_.execute(i); }
	action mem_rmw_11_mem_Valid1(in bit<16> i) {	__ra__ncvm_atomic_cond_write_bool_18_1_1_le_0_.execute(i); }
	...
	action mem_rmw_4_mem_HitCounts0(in bit<16> i) {	__ra__ncvm_atomic_cond_write_u32_11_0_0_le_0_.execute(i); }
	action mem_rmw_5_mem_HitCounts1(in bit<16> i) {	__ra__ncvm_atomic_cond_write_u32_12_0_0_le_0_.execute(i); }
	action mem_rmw_6_mem_HitCounts0(in bit<16> i) {	__ra__ncvm_atomic_cond_sadd_u32_15_1_0_le_0_.execute(i); }
	action mem_rmw_7_mem_HitCounts1(in bit<16> i) {	__ra__ncvm_atomic_cond_sadd_u32_16_1_0_le_0_.execute(i); }
	action mem_rmw_8_mem_Valid0(in bit<16> i) {	__ra__ncvm_atomic_cond_write_bool_17_1_1_le_0_.execute(i); }
	action mem_rmw_9_mem_Valid1(in bit<16> i) {	__ra__ncvm_atomic_cond_write_bool_18_1_1_le_0_.execute(i); }
		...
		if (_tmp__2_call_i20) {
			...
			switch (ncvm_swi_tbl_0.apply().action_run) {
				ncvm_swi_tbl_0_action_0 : {
					...
					mem_rmw_4_mem_HitCounts0(_lv__1_cacheline);
					mem_rmw_5_mem_HitCounts1(_lv__1_cacheline);
				...
				ncvm_swi_tbl_0_action_2 : {
					if (((bool) _lv__2_bitmap[0:0]))
						_tmp__46_cond_in_in = _mem_Valid0.read(_lv__1_cacheline);
					else
						_tmp__46_cond_in_in = _mem_Valid1.read(_lv__1_cacheline);
					if ((_tmp__46_cond_in_in == 0)) { }
					else {
						...
						mem_rmw_6_mem_HitCounts0(_lv__1_cacheline);
						mem_rmw_7_mem_HitCounts1(_lv__1_cacheline);
