...
control ingress( inout headers hdr,
  ...
  action get_acptid(bit<8> id) { acptid = id; }
  ...
  action write_value_1() { registerValue1.write(hdr.paxos.inst, hdr.paxos.paxosval1); }// [31:0]);  }
  action write_value_2() { registerValue2.write(hdr.paxos.inst, hdr.paxos.paxosval2); }// [63:31]); }
  action write_value_3() { registerValue3.write(hdr.paxos.inst, hdr.paxos.paxosval3); }// [95:63]); }
  action write_value_4() { registerValue4.write(hdr.paxos.inst, hdr.paxos.paxosval4); }// [127:95]); }
  action write_value_5() { registerValue5.write(hdr.paxos.inst, hdr.paxos.paxosval5); }// [159:127]);}
  action write_value_6() { registerValue6.write(hdr.paxos.inst, hdr.paxos.paxosval6); }// [191:159]);}
  action write_value_7() { registerValue7.write(hdr.paxos.inst, hdr.paxos.paxosval7); }// [223:191]);}
  action write_value_8() { registerValue8.write(hdr.paxos.inst, hdr.paxos.paxosval8); }// [255:223]);}
  ...
  action update_round() { registerRound.write(hdr.paxos.inst, hdr.paxos.rnd); }
  ...
  action update_history_action() { meta.paxos_metadata.ack_acceptors = update_history.execute(hdr.paxos.inst); }
  action write_history_action() { meta.paxos_metadata.ack_acceptors = write_history.execute(hdr.paxos.inst); }
  table history_tbl {
    key = {
      round_check: ternary;
    }
