...
// target: tna
// location: 1
// source-file: /home/gk/vbox-share/p4utils-lubuntu-20.04/ncl-p4/agg/src/device/allreduce.ncl
#include <core.p4>
#include <tna.p4>
...
control ncl_compute(inout headers H,
	...
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Expo) __ra__ncvm_atomic_write_u32_38_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_5[0].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_0_) __ra__ncvm_atomic_write_u32_39_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[0].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_1_) __ra__ncvm_atomic_write_u32_40_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[1].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_2_) __ra__ncvm_atomic_write_u32_41_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[2].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_3_) __ra__ncvm_atomic_write_u32_42_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[3].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_4_) __ra__ncvm_atomic_write_u32_43_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[4].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_5_) __ra__ncvm_atomic_write_u32_44_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[5].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_6_) __ra__ncvm_atomic_write_u32_45_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[6].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_7_) __ra__ncvm_atomic_write_u32_46_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[7].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_8_) __ra__ncvm_atomic_write_u32_47_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[8].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_9_) __ra__ncvm_atomic_write_u32_48_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[9].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_10_) __ra__ncvm_atomic_write_u32_49_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[10].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_11_) __ra__ncvm_atomic_write_u32_50_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[11].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_12_) __ra__ncvm_atomic_write_u32_51_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[12].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_13_) __ra__ncvm_atomic_write_u32_52_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[13].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_14_) __ra__ncvm_atomic_write_u32_53_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[14].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_15_) __ra__ncvm_atomic_write_u32_54_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[15].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_16_) __ra__ncvm_atomic_write_u32_55_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[16].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_17_) __ra__ncvm_atomic_write_u32_56_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[17].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_18_) __ra__ncvm_atomic_write_u32_57_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[18].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_19_) __ra__ncvm_atomic_write_u32_58_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[19].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_20_) __ra__ncvm_atomic_write_u32_59_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[20].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_21_) __ra__ncvm_atomic_write_u32_60_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[21].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_22_) __ra__ncvm_atomic_write_u32_61_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[22].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_23_) __ra__ncvm_atomic_write_u32_62_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[23].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_24_) __ra__ncvm_atomic_write_u32_63_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[24].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_25_) __ra__ncvm_atomic_write_u32_64_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[25].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_26_) __ra__ncvm_atomic_write_u32_65_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[26].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_27_) __ra__ncvm_atomic_write_u32_66_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[27].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_28_) __ra__ncvm_atomic_write_u32_67_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[28].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_29_) __ra__ncvm_atomic_write_u32_68_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[29].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_30_) __ra__ncvm_atomic_write_u32_69_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[30].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Agg_fragment_31_) __ra__ncvm_atomic_write_u32_70_1_0_m_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = H.ncp_data_1_6[31].value;
		}
	};
	RegisterAction<bit<32>, bit<8>, bit<32>>(_mem_Count) __ra__ncvm_atomic_write_u32_71_1_0_e_0_ = {
		void apply(inout bit<32> R, out bit<32> O){
			O = ((bit<32>) R);
			R = 3;
		}
	...
	action mem_rmw_10_mem_Agg_fragment_7_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_46_1_0_m_0_.execute(i); }
	action mem_rmw_11_mem_Agg_fragment_8_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_47_1_0_m_0_.execute(i); }
	action mem_rmw_12_mem_Agg_fragment_9_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_48_1_0_m_0_.execute(i); }
	action mem_rmw_13_mem_Agg_fragment_10_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_49_1_0_m_0_.execute(i); }
	action mem_rmw_14_mem_Agg_fragment_11_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_50_1_0_m_0_.execute(i); }
	action mem_rmw_15_mem_Agg_fragment_12_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_51_1_0_m_0_.execute(i); }
	action mem_rmw_16_mem_Agg_fragment_13_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_52_1_0_m_0_.execute(i); }
	action mem_rmw_17_mem_Agg_fragment_14_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_53_1_0_m_0_.execute(i); }
	action mem_rmw_18_mem_Agg_fragment_15_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_54_1_0_m_0_.execute(i); }
	action mem_rmw_19_mem_Agg_fragment_16_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_55_1_0_m_0_.execute(i); }
	action mem_rmw_1_mem_Bitmap_fragment_1_(in bit<8> i) {	__ra__ncvm_atomic_and_u16_3_1_0_l_0_.execute(i); }
	action mem_rmw_20_mem_Agg_fragment_17_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_56_1_0_m_0_.execute(i); }
	action mem_rmw_21_mem_Agg_fragment_18_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_57_1_0_m_0_.execute(i); }
	action mem_rmw_22_mem_Agg_fragment_19_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_58_1_0_m_0_.execute(i); }
	action mem_rmw_23_mem_Agg_fragment_20_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_59_1_0_m_0_.execute(i); }
	action mem_rmw_24_mem_Agg_fragment_21_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_60_1_0_m_0_.execute(i); }
	action mem_rmw_25_mem_Agg_fragment_22_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_61_1_0_m_0_.execute(i); }
	action mem_rmw_26_mem_Agg_fragment_23_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_62_1_0_m_0_.execute(i); }
	action mem_rmw_27_mem_Agg_fragment_24_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_63_1_0_m_0_.execute(i); }
	action mem_rmw_28_mem_Agg_fragment_25_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_64_1_0_m_0_.execute(i); }
	action mem_rmw_29_mem_Agg_fragment_26_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_65_1_0_m_0_.execute(i); }
	action mem_rmw_2_mem_Expo(in bit<8> i) {	__ra__ncvm_atomic_write_u32_38_1_0_m_0_.execute(i); }
	action mem_rmw_30_mem_Agg_fragment_27_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_66_1_0_m_0_.execute(i); }
	action mem_rmw_31_mem_Agg_fragment_28_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_67_1_0_m_0_.execute(i); }
	action mem_rmw_32_mem_Agg_fragment_29_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_68_1_0_m_0_.execute(i); }
	action mem_rmw_33_mem_Agg_fragment_30_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_69_1_0_m_0_.execute(i); }
	action mem_rmw_34_mem_Agg_fragment_31_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_70_1_0_m_0_.execute(i); }
	action mem_rmw_35_mem_Count(in bit<8> i) {	__ra__ncvm_atomic_write_u32_71_1_0_e_0_.execute(i); }
	action mem_rmw_3_mem_Agg_fragment_0_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_39_1_0_m_0_.execute(i); }
	action mem_rmw_4_mem_Agg_fragment_1_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_40_1_0_m_0_.execute(i); }
	action mem_rmw_5_mem_Agg_fragment_2_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_41_1_0_m_0_.execute(i); }
	action mem_rmw_6_mem_Agg_fragment_3_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_42_1_0_m_0_.execute(i); }
	action mem_rmw_7_mem_Agg_fragment_4_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_43_1_0_m_0_.execute(i); }
	action mem_rmw_8_mem_Agg_fragment_5_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_44_1_0_m_0_.execute(i); }
	action mem_rmw_9_mem_Agg_fragment_6_(in bit<8> i) {	__ra__ncvm_atomic_write_u32_45_1_0_m_0_.execute(i); }
	...
	apply {
		...
		if ((_lv__0_bitmap_0_reg2mem == 0)) {
			mem_rmw_2_mem_Expo(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_3_mem_Agg_fragment_0_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_4_mem_Agg_fragment_1_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_5_mem_Agg_fragment_2_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_6_mem_Agg_fragment_3_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_7_mem_Agg_fragment_4_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_8_mem_Agg_fragment_5_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_9_mem_Agg_fragment_6_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_10_mem_Agg_fragment_7_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_11_mem_Agg_fragment_8_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_12_mem_Agg_fragment_9_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_13_mem_Agg_fragment_10_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_14_mem_Agg_fragment_11_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_15_mem_Agg_fragment_12_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_16_mem_Agg_fragment_13_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_17_mem_Agg_fragment_14_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_18_mem_Agg_fragment_15_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_19_mem_Agg_fragment_16_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_20_mem_Agg_fragment_17_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_21_mem_Agg_fragment_18_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_22_mem_Agg_fragment_19_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_23_mem_Agg_fragment_20_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_24_mem_Agg_fragment_21_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_25_mem_Agg_fragment_22_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_26_mem_Agg_fragment_23_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_27_mem_Agg_fragment_24_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_28_mem_Agg_fragment_25_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_29_mem_Agg_fragment_26_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_30_mem_Agg_fragment_27_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_31_mem_Agg_fragment_28_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_32_mem_Agg_fragment_29_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_33_mem_Agg_fragment_30_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_34_mem_Agg_fragment_31_(((bit<8>) H.ncp_data_1_3[0].value));
			mem_rmw_35_mem_Count(((bit<8>) H.ncp_data_1_3[0].value));
		}
		else {
