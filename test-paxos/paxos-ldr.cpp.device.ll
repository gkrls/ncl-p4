; ModuleID = '/home/gk/vbox-share/netcl-ubuntu-22.04/ncl-p4/test/paxos-ldr.cpp.device.rw'
source_filename = "/home/gk/vbox-share/netcl-ubuntu-22.04/ncl-p4/test/paxos-ldr.cpp"
...
@.str.13 = private unnamed_addr constant [65 x i8] c"/home/gk/vbox-share/netcl-ubuntu-22.04/ncl-p4/test/paxos-ldr.cpp\00", section "llvm.metadata"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_paxos_ldr.cpp.device.rw, i8* null }]
...
; Function Attrs: noinline nounwind
define internal void @_GLOBAL__sub_I_paxos_ldr.cpp.device.rw() #3 section ".text.startup" !dbg !68 {
entry:
...
!32 = distinct !DISubprogram(name: "__ncvm_atomic_add_u32", scope: !7, file: !7, line: 230, type: !8, scopeLine: 230, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!33 = !DILocation(line: 230, column: 1, scope: !32)
!34 = distinct !DISubprogram(name: "__ncvm_atomic_sadd_u8", scope: !7, file: !7, line: 245, type: !8, scopeLine: 245, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!35 = !DILocation(line: 245, column: 1, scope: !34)
!36 = distinct !DISubprogram(name: "__ncvm_atomic_sadd_u16", scope: !7, file: !7, line: 246, type: !8, scopeLine: 246, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!37 = !DILocation(line: 246, column: 1, scope: !36)
!38 = distinct !DISubprogram(name: "__ncvm_atomic_sadd_u32", scope: !7, file: !7, line: 247, type: !8, scopeLine: 247, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!39 = !DILocation(line: 247, column: 1, scope: !38)
!40 = distinct !DISubprogram(name: "__ncvm_atomic_sadd_u64", scope: !7, file: !7, line: 248, type: !8, scopeLine: 248, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!41 = !DILocation(line: 248, column: 1, scope: !40)
...
!48 = !DIFile(filename: "paxos-ldr.cpp", directory: "/home/gk/vbox-share/netcl-ubuntu-22.04/ncl-p4/test")
!49 = !DILocation(line: 24, column: 7, scope: !47)
!50 = !DILocation(line: 25, column: 10, scope: !47)
!51 = !DILocation(line: 123, column: 82, scope: !52, inlinedAt: !54)
!52 = distinct !DISubprogram(name: "atomic_add", scope: !53, file: !53, line: 123, type: !8, scopeLine: 123, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
...
!68 = distinct !DISubprogram(linkageName: "_GLOBAL__sub_I_paxos_ldr.cpp.device.rw", scope: !1, file: !1, type: !8, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !2)
