; ModuleID = '/home/gk/vbox-share/netcl-ubuntu-22.04/ncl-p4/packet-latency/plrn-ncl/paxos-lrn-orig.cpp.device.rw'
source_filename = "/home/gk/vbox-share/netcl-ubuntu-22.04/ncl-p4/packet-latency/plrn-ncl/paxos-lrn-orig.cpp"
...
@.str.12 = private unnamed_addr constant [89 x i8] c"/home/gk/vbox-share/netcl-ubuntu-22.04/ncl-p4/packet-latency/plrn-ncl/paxos-lrn-orig.cpp\00", section "llvm.metadata"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_paxos_lrn_orig.cpp.device.rw, i8* null }]
...
; Function Attrs: noinline nounwind
define internal void @_GLOBAL__sub_I_paxos_lrn_orig.cpp.device.rw() #5 section ".text.startup" !dbg !98 {
entry:
...
!54 = !DIFile(filename: "paxos-lrn-orig.cpp", directory: "/home/gk/vbox-share/netcl-ubuntu-22.04/ncl-p4/packet-latency/plrn-ncl")
...
!82 = !DILocation(line: 38, column: 5, scope: !53)
...
!87 = !DILocation(line: 42, column: 35, scope: !53)
!88 = !DILocation(line: 42, column: 33, scope: !53)
...
!92 = distinct !DILocation(line: 42, column: 10, scope: !53)
!93 = !DILocation(line: 42, column: 9, scope: !53)
!94 = !DILocation(line: 15, column: 3, scope: !66, inlinedAt: !95)
!95 = distinct !DILocation(line: 43, column: 14, scope: !53)
!96 = !DILocation(line: 43, column: 7, scope: !53)
!97 = !DILocation(line: 45, column: 1, scope: !53)
!98 = distinct !DISubprogram(linkageName: "_GLOBAL__sub_I_paxos_lrn_orig.cpp.device.rw", scope: !1, file: !1, type: !8, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !2)
